...
#define GetTimeMicroseconds(t) std::chrono::time_point_cast<std::chrono::microseconds>(t).time_since_epoch()
	...
	public:
		...
		void BeginSession(const std::string& name, const std::string& filepath = "results.json")
		{
			...
			if (m_CurrentSession) {
				...
				// newly opened sessions instead.	That's better than having badly formatted
				// profiling output.
	...
	public:
		...
		void Stop()
		{
			...
			auto elapsedTime = GetTimeMicroseconds(endTimepoint) - GetTimeMicroseconds(m_StartTimepoint);
