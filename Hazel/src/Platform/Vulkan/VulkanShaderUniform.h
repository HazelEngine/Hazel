...
namespace Hazel {
	...
	class VulkanShaderResourceDeclaration : public ShaderResourceDeclaration
	{
	...
	class VulkanShaderUniformDeclaration : public ShaderUniformDeclaration
	{
		friend class VulkanShader;
		friend class VulkanShaderUniformBufferDeclaration;
	...
	public:
		VulkanShaderUniformBufferDeclaration(const std::string& name, uint32_t binding, ShaderDomain domain);

		void PushUniform(VulkanShaderUniformDeclaration* uniform);
